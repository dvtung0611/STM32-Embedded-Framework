...
void CAN1_TX_IRQHandler 			    (void) __attribute__ ((weak));         
...
void CAN2_RX0_IRQHandler         	    (void) __attribute__ ((weak));
void CAN2_RX1_IRQHandler         	    (void) __attribute__ ((weak));
void CAN2_SCE_IRQHandler         	    (void) __attribute__ ((weak));
